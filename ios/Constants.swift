...
let REMOTE_WORKOUT_SESSION_NOT_FOUND_ERROR = "HEALTHKIT_REMOTE_WORKOUT_SESSION_NOT_FOUND_ERROR"
let REMOTE_WORKOUT_SESSION_NOT_FOUND_ERROR_MESSAGE = "Remote workout session not found"
