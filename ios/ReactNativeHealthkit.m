...
RCT_EXTERN_METHOD(pauseMirroringWorkoutSession:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject
)

RCT_EXTERN_METHOD(resumeMirroringWorkoutSession:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject
)
