...
var _exportNames = {
  ...
  pauseMirroringWorkoutSession: true,
  resumeMirroringWorkoutSession: true,
...
const authorizationStatusFor = exports.authorizationStatusFor = UnavailableFn(Promise.resolve(_nativeTypes.HKAuthorizationStatus.notDetermined)),
  ...
  queryStatisticsCollectionForQuantity = exports.queryStatisticsCollectionForQuantity = UnavailableFn(Promise.resolve([{
    averageQuantity: undefined,
    maximumQuantity: undefined,
    minimumQuantity: undefined,
    sumQuantity: undefined,
  ...
  pauseMirroringWorkoutSession = exports.pauseMirroringWorkoutSession = UnavailableFn(Promise.resolve(false)),
  resumeMirroringWorkoutSession = exports.resumeMirroringWorkoutSession = UnavailableFn(Promise.resolve(false)),
  endMirroringWorkoutSession = UnavailableFn(Promise.resolve(false)),
  ...
  queryStateOfMindSamples = exports.queryStateOfMindSamples = UnavailableFn(Promise.resolve([]));
